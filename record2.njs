...
({
  ...
  database:'uidd2017_groupL'
      ...
      /*
           console.log(res[i].dateyear);
           console.log(res[i].datemonth);
           console.log(res[i].dateday);
           console.log(res[i].timehour);
           console.log(res[i].timeminute);
           console.log(res[i].NT);
      */   
       }
           connection.end();
       });
